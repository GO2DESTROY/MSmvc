...
class  MS_modelQueryBuilder {
    ...
    /**
     * @param array $fields : these fields will be marked for primary key
     *
     * @return $this
     */
    public function setPrimaryKey(array $fields) {
        $this->primaryKeysSets[] = $fields;
        return $this;
    }
    ...
    private function propertyToField(MS_property $property) {
        return "$property->name $property->type ($property->length),";
    }
