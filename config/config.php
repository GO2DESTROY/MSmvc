...
return [
	...
	'development' => ['error-logging' => 'MS_handler', // we can choice between the custom MS_handler, none
		...
		'routesLocation' => 'local'], 	// this will be used to load the routes you can use: local = this will use the config/routes.php or you could use a data set defined in the database file
