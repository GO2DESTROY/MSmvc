...
return [
	...
	'development' => ['error-logging' => 'Handler', // we can choice between the custom Handler, none
	...
	'live' => ['error-logging' => 'Handler', // we can choice between the custom Handler, none
